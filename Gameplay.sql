...
INSERT OR IGNORE INTO Modifiers (ModifierId, ModifierType, Name, SubjectRequirementSetId)
VALUES 
    ('CXP_MOD_ARMY',  'MODIFIER_PLAYER_UNITS_ADJUST_EXPERIENCE_MODIFIER', 'LOC_CXP_MOD_NAME', 'CXP_SET_ARMY'),
    ('CXP_MOD_FLEET', 'MODIFIER_PLAYER_UNITS_ADJUST_EXPERIENCE_MODIFIER', 'LOC_CXP_MOD_NAME', 'CXP_SET_FLEET'),
    ('CXP_MOD_AIR',   'MODIFIER_PLAYER_UNITS_ADJUST_EXPERIENCE_MODIFIER', 'LOC_CXP_MOD_NAME', 'CXP_SET_AIR'),
    ('CXP_MOD_AERO',  'MODIFIER_PLAYER_UNITS_ADJUST_EXPERIENCE_MODIFIER', 'LOC_CXP_MOD_NAME', 'CXP_SET_AERO'),
    ('CXP_MOD_OTHER', 'MODIFIER_PLAYER_UNITS_ADJUST_EXPERIENCE_MODIFIER', 'LOC_CXP_MOD_NAME', 'CXP_SET_OTHER');
